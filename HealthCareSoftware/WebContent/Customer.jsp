...
<body class = "bodyAdmin" style ="margin-left : 0; margin-right : 15%;">
		...
		<div class="w3-sidebar w3-bar-block w3-card" style="width:15%;right:0; background-color : #000;">
		  ...
		  <a href="Hospitals.jsp" class="w3-bar-item w3-button" style = "color : #fff; font-family : Poppins; text-decoration : none; background-color:red;">Logout</a>
		</div>
		
		<!-- Page Content -->
		<div style="margin-right:0%; background-color : gray;">
		
		<div class="w3-container w3-teal text-center" style = "background : white; margin-bottom : -60px;">
		  <h1 style = "color : #fff; font-family : Raleway; color : #000; text-transform : uppercase;">Health Care Web Application</h1>
		</div>
		
		<img class = " float-left"src="Images/logohealth.png" style ="margin-left : 20px; margin-top : 10px;" >
		<h2 class = "w3-container text-center" style = "font-family : Poppins; text-transform : uppercase;">Administration</h2>
		
		<div class="w3-container">
		<jsp:include page="WEB-INF/Views/ManageCustomer.jsp"></jsp:include>
		
		<div class = "btn text-end">
		<form>
		<button type="submit" class="btn btn-primary btn-sm" style = "margin-right:0; font-family : Poppins;">Update Patients</button>
		</form>
		</div>
		</div><br><br><br>
		</div><br><br><br>
